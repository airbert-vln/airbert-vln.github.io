...
const DATA_DIR = "matterport_mesh/v1/scans/";
...
// Marker colors
const START_COLOR = 0xf1c40f;
const GROUND_TRUTH_COLOR = 0x45b39d;
const AIRBERT_COLOR = 0x5499c7;
const VLNBERT_COLOR = 0xa569bd;
